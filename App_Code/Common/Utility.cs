...
public static class Utility
{
    ...
    //EditContentRow
    public static string GeneratePopupContentFromContentID(int contentID, bool isBox, bool isContentAdmin)
    {
        if (isContentAdmin)
            return getPopDataAdmin(contentID,isBox);
        else
            return getPopDataNonAdmin(contentID, isBox);
    }

    private static string getPopDataAdmin(int contentID, bool isBox)
    {
        string htmlData = "";
    ...
    private static string getPopDataNonAdmin(int contentID, bool isBox)
    {
        string htmlData = "";
        ContentObj c0 = new ContentObj();
