...
#region Constructors
    ...
    public BasicData(SqlConnection _conn) : this()
        {
        conn = _conn;
        }
    ...
    public BasicData(string _connectionString) : this()
        {
    ...
    public BasicData(SqlConnection _conn, int _BasicDataID) : this()
        {
        conn = _conn;
    ...
    /// <param name="_ConnectionString">Database connection string to be used in further operations</param>
    /// <param name="_BasicDataID">A primary key column in the BasicData table</param>
    public BasicData(string _connectionString, int _BasicDataID) : this()
        {
        connectionString = _connectionString;
        getRecord(_BasicDataID);
        }
...
#region Methods
    ...
    public bool insert()
        ...
        try
            {
            connect();
            cmd = new SqlCommand("INSERT INTO \"BasicData\" (Name, ParentID,UserDefinedID) VALUES (@Name, @ParentID,@UserDefinedID)", conn);
    ...
    public bool update()
        ...
        try
            {
            connect();
            cmd = new SqlCommand("UPDATE \"BasicData\" SET Name = @Name, ParentID = @ParentID WHERE BasicDataID = @BasicDataID", conn);
