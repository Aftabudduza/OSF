<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.master" AutoEventWireup="true"
    CodeFile="AdminSystemSetting.aspx.cs" Inherits="Admin_AdminSystemSetting" %>
        ...
        <ContentTemplate>
            <div class="mid-container" style="margin: 0 0 0 205px;">
                <asp:GridView ID="gvSystem" runat="Server" Width="100%" Style="margin: 15px 0;" AllowPaging="True"
                    ...
                    GridLines="Vertical" PageSize="15" SelectedIndex="0" ShowFooter="False" OnRowEditing="gvSystem_RowEditing"
                    OnRowUpdating="gvSystem_RowUpdating" OnRowCancelingEdit="gvSystem_RowCancelingEdit"
